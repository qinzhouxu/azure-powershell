...
external help file:
Module Name: Az.Acat
online version: https://learn.microsoft.com/powershell/module/az.acat/invoke-azacatdownloadreport
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Acat.Support.DownloadType
Parameter Sets: (All)
Aliases:
